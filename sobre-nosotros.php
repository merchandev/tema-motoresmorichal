    ...
    <div class="container about-hero-grid">
      ...
      <div class="about-hero-visual">
        <figure class="bento main gallery-item" data-index="0">
          <img src="https://arturomerchan.com/wp-content/uploads/2025/11/IMG_0481-scaled.jpg" alt="Fachada de Motores Morichal" loading="lazy" />
        </figure>
        <div class="bento-stack">
          <figure class="bento card gallery-item" data-index="1">
            <img src="https://arturomerchan.com/wp-content/uploads/2025/11/IMG_0611-scaled.jpg" alt="Showroom de Motores Morichal en Tipuro" loading="lazy" />
          </figure>
          <figure class="bento card gallery-item" data-index="2">
            <img src="https://arturomerchan.com/wp-content/uploads/2025/11/IMG_0326-scaled.jpg" alt="Espacios interiores del concesionario" loading="lazy" />
          </figure>
        </div>
      </div>
    </div>
  ...
  <section class="about-focus scroll-section is-visible">
    <div class="container focus-grid">
      <div class="focus-media gallery-item" data-index="3">
        <img src="https://arturomerchan.com/wp-content/uploads/2025/11/IMG_0457-scaled.jpg" alt="Atenci&oacute;n y servicio en Motores Morichal" loading="lazy" />
      </div>
