<?php
/* Single template for CPT Vehículos Usados - Premium White Design */
get_header();
  ...
  <section class="vp-ficha">
    <div class="container">
      <div class="vp-ficha-card">
        <p class="vp-ficha-kicker">Contáctanos</p>
        <h2 class="vp-ficha-title">Consulta disponibilidad de este vehículo usado</h2>
        <p class="vp-ficha-text">Nuestros operadores están disponibles para atender cualquier duda sobre <?php the_title(); ?>.</p>
