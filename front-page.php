<?php get_header(); ?><main id="site-main" class="vehiculo-premium-white">
  <!-- Slider de videos -->
  <div id="custom-slider" class="custom-slider swiper" role="region" aria-label="Slider principal Toyota">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide cs-slide" data-index="1" data-type="video">
        <video class="cs-video-bg" muted playsinline preload="metadata" data-src="<?php echo esc_url( get_theme_mod('home_video_1', get_template_directory_uri().'/assets/video/home/video-fortuner.mp4') ); ?>" crossorigin="anonymous"></video>
        <div class="cs-slide-content cs-left animate-in">
      ...
      <div class="swiper-slide cs-slide" data-index="2" data-type="image">
        <picture style="width: 100%; height: 100%;">
          <source media="(max-width: 768px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/home/banner-app-mobile.png">
          <img class="cs-video-bg" src="<?php echo get_template_directory_uri(); ?>/assets/img/home/banner-app-desktop.jpg" alt="Toyota APP" style="object-fit: cover; width: 100%; height: 100%;">
        </picture>
        <div class="cs-slide-content cs-left animate-in">
          <h2>Toyota APP</h2>
      ...
      <div class="swiper-slide cs-slide" data-index="3" data-type="video">
        <video class="cs-video-bg" muted playsinline preload="metadata" data-src="<?php echo esc_url( get_theme_mod('home_video_2', get_template_directory_uri().'/assets/video/home/video-yaris.mp4') ); ?>" crossorigin="anonymous"></video>
        <div class="cs-slide-content cs-left animate-in">
      ...
      <div class="swiper-slide cs-slide" data-index="4" data-type="video">
        <video class="cs-video-bg" muted playsinline preload="metadata" data-src="<?php echo esc_url( get_theme_mod('home_video_3', get_template_directory_uri().'/assets/video/home/video-corolla.mp4') ); ?>" crossorigin="anonymous"></video>
        <div class="cs-slide-content cs-left animate-in">
      ...
      <div class="swiper-slide cs-slide" data-index="5" data-type="video">
        <video class="cs-video-bg" muted playsinline preload="metadata" data-src="<?php echo esc_url( get_theme_mod('home_video_4', 'https://mmorichal.com/wp-content/uploads/2025/09/AGYA-TOYOTA-MONAGAS.mp4') ); ?>" crossorigin="anonymous"></video>
        <div class="cs-slide-content cs-left animate-in">
          <h2>AGYA 2025</h2>
      ...
      <div class="swiper-slide cs-slide" data-index="6" data-type="image">
        <picture style="width: 100%; height: 100%;">
          <source media="(max-width: 768px)" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/home/banner-recall-mobile.jpg">
          <img class="cs-video-bg" src="<?php echo get_template_directory_uri(); ?>/assets/img/home/banner-recall-desktop.png" alt="Campaña de Recall" style="object-fit: cover; width: 100%; height: 100%;">
        </picture>
        <div class="cs-slide-content cs-left animate-in">
